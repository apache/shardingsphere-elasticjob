...
public interface DagOperateAPI {
     ...
     */
    boolean toggleDagPause(String groupName);
     ...
     * @return toggle success?
     */
    boolean toggleDagResume(String groupName);
     ...
     * @return toggle success?
     */
    boolean toggleDagStart(String groupName);
     ...
     * @return toggle success?
     */
    boolean toggleDagStop(String groupName);
     ...
     * @return toggle success?
     */
    boolean toggleDagRerunWhenFail(String groupName);

    /**
     * query dag group list.
     *
     * @return dag info list
     */
    List<DagBriefInfo> getDagGroupNameList();
     ...
     * @return dag info list
     */
    List<DagBriefInfo> getDagJobDependencies(String groupName);
}
