...
@Getter
@Setter
public class ScriptJobConfigurationDto extends AbstractJobConfigurationDto<ScriptJobConfiguration, ScriptElasticJob, ScriptJobConfigurationBuilder> {
    ...
    @Override
    protected ScriptJobConfigurationBuilder createCustomizedBuilder() {
        return new ScriptJobConfigurationBuilder(getJobName(), getShardingTotalCount(), getCron(), getScriptCommandLine());
    } 
    
    @Override
    protected ScriptJobConfigurationBuilder buildCustomizedProperties(final ScriptJobConfigurationBuilder builder) {
