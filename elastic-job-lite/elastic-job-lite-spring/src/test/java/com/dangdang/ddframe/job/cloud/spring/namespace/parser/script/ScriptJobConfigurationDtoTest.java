...
package com.dangdang.ddframe.job.cloud.spring.namespace.parser.script;

import com.dangdang.ddframe.job.cloud.api.config.impl.ScriptJobConfiguration.ScriptJobConfigurationBuilder;
import org.junit.Test;
import org.mockito.internal.matchers.apachecommons.ReflectionEquals;

import static com.dangdang.ddframe.job.cloud.spring.util.JobConfigurationDtoHelper.buildJobConfigurationBuilder;
import static com.dangdang.ddframe.job.cloud.spring.util.JobConfigurationDtoHelper.buildJobConfigurationDto;
...
public final class ScriptJobConfigurationDtoTest {
    ...
    public void testBuildScriptJobConfigurationDtoWithCustomizedProperties() {
        ...
        ScriptJobConfigurationBuilder builder = (ScriptJobConfigurationBuilder) buildJobConfigurationBuilder(createScriptJobConfigurationBuilder());
    ...
    private ScriptJobConfigurationBuilder createScriptJobConfigurationBuilder() {
        return new ScriptJobConfigurationBuilder("scriptJob", 10, "0/1 * * * * ?", "test.sh");
    }
}
