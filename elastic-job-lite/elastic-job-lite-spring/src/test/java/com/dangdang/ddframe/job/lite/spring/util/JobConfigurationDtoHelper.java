...
public class JobConfigurationDtoHelper {
    ...
    public static AbstractJobConfiguration.AbstractJobConfigurationBuilder buildJobConfigurationBuilder(final AbstractJobConfiguration.AbstractJobConfigurationBuilder jobConfigurationBuilder) {
