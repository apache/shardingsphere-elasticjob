 ...
 * @author zhangliang
 */
public class InstanceShutdownListenerManager extends AbstractListenerManager {
    ...
    public InstanceShutdownListenerManager(final CoordinatorRegistryCenter regCenter, final String jobName) {
