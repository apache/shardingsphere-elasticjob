...
package com.dangdang.ddframe.job.cloud.internal.guarantee;
...
import com.dangdang.ddframe.job.cloud.internal.listener.AbstractJobListener;
import com.dangdang.ddframe.job.cloud.internal.listener.AbstractListenerManager;
...
public class GuaranteeListenerManager extends AbstractListenerManager {
    ...
    public GuaranteeListenerManager(final CoordinatorRegistryCenter coordinatorRegistryCenter, final JobConfiguration jobConfiguration, final List<ElasticJobListener> elasticJobListeners) {
