...
function generateOperationButtons(val, row) {
    ...
    if (row.activated) {
        ...
        operationTd = "<button disabled operation='connectDataSource' class='btn' dataSourceName='" + name + "'>已连</button><button operation='deleteDataSource' class='btn btn-danger' data-toggle='modal' id='delete-dialog' dataSourceName='" + name + "'>删除</button>";
    } else {
        operationTd = "<button operation='connectDataSource' class='btn btn-primary' dataSourceName='" + name + "' data-loading-text='切换中...'>连接</button><button operation='deleteDataSource' class='btn btn-danger' data-toggle='modal' id='delete-dialog' dataSourceName='" + name + "'>删除</button>";
    }
    return operationTd;
}
