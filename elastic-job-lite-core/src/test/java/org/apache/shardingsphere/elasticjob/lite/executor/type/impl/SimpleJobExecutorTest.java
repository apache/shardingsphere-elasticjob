...
//    
//    @Test(expected = JobSystemException.class)
//    public void assertExecuteFailureWhenThrowExceptionForSingleShardingItem() throws JobExecutionEnvironmentException {
//        assertExecuteWhenRunOnceAndThrowException(ShardingContextsBuilder.getSingleShardingContexts());
//    }
//    
//    @Test
//    public void assertExecuteFailureWhenThrowExceptionForMultipleShardingItems() throws JobExecutionEnvironmentException {
...
//    
//    @Test
//    public void assertExecuteWithMisfire() throws JobExecutionEnvironmentException {
//        ShardingContexts shardingContexts = ShardingContextsBuilder.getMultipleShardingContexts();
//        when(jobFacade.getShardingContexts()).thenReturn(shardingContexts);
