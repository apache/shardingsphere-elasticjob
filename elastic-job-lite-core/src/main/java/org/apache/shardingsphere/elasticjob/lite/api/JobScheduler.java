...
public final class JobScheduler {
    ...
    public void init() {
        ...
        JobRegistry.getInstance().setCurrentShardingTotalCount(jobConfigFromRegCenter.getJobName(), jobConfigFromRegCenter.getCoreConfig().getShardingTotalCount());
        ...
        jobScheduleController.scheduleJob(jobConfigFromRegCenter.getCoreConfig().getCron());
    }
