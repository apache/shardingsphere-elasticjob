...
public final class JobScheduler {
    ...
    public JobScheduler(final CoordinatorRegistryCenter regCenter, final ElasticJob elasticJob, final LiteJobConfiguration liteJobConfig, final TracingListenerConfiguration jobEventConfig, 
