...
import com.dangdang.ddframe.job.plugin.job.type.fixture.FooUnstreamingBatchSequenceDataFlowElasticJob;
import com.dangdang.ddframe.job.plugin.job.type.fixture.JobCaller;

public final class UnstreamingBatchSequenceDataFlowElasticJobTest {
    ...
    private FooUnstreamingBatchSequenceDataFlowElasticJob unstreamingBatchSequenceDataFlowElasticJob;
    ...
    public void setUp() throws NoSuchFieldException {
        ...
        unstreamingBatchSequenceDataFlowElasticJob = new FooUnstreamingBatchSequenceDataFlowElasticJob(jobCaller);
        unstreamingBatchSequenceDataFlowElasticJob.setConfigService(configService);
        unstreamingBatchSequenceDataFlowElasticJob.setShardingService(shardingService);
        unstreamingBatchSequenceDataFlowElasticJob.setExecutionContextService(executionContextService);
        unstreamingBatchSequenceDataFlowElasticJob.setExecutionService(executionService);
        unstreamingBatchSequenceDataFlowElasticJob.setFailoverService(failoverService);
        unstreamingBatchSequenceDataFlowElasticJob.setOffsetService(offsetService);
    ...
    public void assertExecuteWhenFetchDataIsNullAndEmpty() throws JobExecutionException {
        ...
        unstreamingBatchSequenceDataFlowElasticJob.execute(null);
