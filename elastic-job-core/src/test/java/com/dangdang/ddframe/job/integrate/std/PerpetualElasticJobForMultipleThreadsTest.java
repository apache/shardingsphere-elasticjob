...
import com.dangdang.ddframe.job.integrate.fixture.PerpetualElasticJob;
import com.dangdang.ddframe.job.internal.statistics.ProcessCountStatistics;
import com.dangdang.ddframe.test.WaitingUtils;

public final class PerpetualElasticJobForMultipleThreadsTest extends AbstractEnabledBaseStdJobTest {
    
    public PerpetualElasticJobForMultipleThreadsTest() {
        super(PerpetualElasticJob.class);
    }
