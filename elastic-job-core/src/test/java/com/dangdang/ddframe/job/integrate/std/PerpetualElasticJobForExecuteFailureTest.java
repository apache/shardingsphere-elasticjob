...
import com.dangdang.ddframe.job.integrate.fixture.PerpetualElasticJobForExecuteFailure;
import com.dangdang.ddframe.job.internal.statistics.ProcessCountStatistics;
import com.dangdang.ddframe.test.WaitingUtils;

public final class PerpetualElasticJobForExecuteFailureTest extends AbstractEnabledBaseStdJobTest {
    
    public PerpetualElasticJobForExecuteFailureTest() {
        super(PerpetualElasticJobForExecuteFailure.class);
    }
    
    @Before
    @After
    public void reset() {
        PerpetualElasticJobForExecuteFailure.reset();
    }
    ...
    public void assertJobInit() {
        ...
        while (!PerpetualElasticJobForExecuteFailure.isCompleted()) {
