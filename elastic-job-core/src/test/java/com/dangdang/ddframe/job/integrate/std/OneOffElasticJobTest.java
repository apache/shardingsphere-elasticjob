...
public final class OneOffElasticJobTest extends AbstractEnabledBaseStdJobTest {
    
    public OneOffElasticJobTest() {
        super(OneOffElasticJob.class);
    }
    ...
    public void assertJobInit() {
        ...
        while (!OneOffElasticJob.isCompleted()) {
