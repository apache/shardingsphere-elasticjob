...
public final class SequencePerpetualElasticJob extends AbstractSequencePerpetualElasticJob<String> {
    ...
    @Override
    protected List<String> fetchData(final JobExecutionSingleShardingContext singleContext) {
    ...
    @Override
    protected boolean processData(final JobExecutionSingleShardingContext singleContext, final String data) {
