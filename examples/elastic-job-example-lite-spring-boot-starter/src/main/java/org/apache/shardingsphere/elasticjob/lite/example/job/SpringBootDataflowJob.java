...
import org.apache.shardingsphere.elasticjob.lite.springboot.annotation.*;
...
@ElasticJob(
        ...
        jobName = "springBootDataflowJob",
        shardingTotalCount = 3,
        shardingItemParameters = "0=Beijing,1=Shanghai,2=Guangzhou",
        cron = "0/10 * * * * ?",
        props = {
                @ElasticJobProperty(name = DataflowJobProperties.STREAM_PROCESS_KEY, value = "true")
        }
)
@Tracing
@RegistryCenter
