...
public final class SchedulerEngine implements Scheduler {
    ...
    public void statusUpdate(final SchedulerDriver schedulerDriver, final Protos.TaskStatus taskStatus) {
        ...
        jobTracingEventBus.post(new JobStatusTraceEvent(jobName, null, taskContext.getId(), taskContext.getSlaveId(), JobStatusTraceEvent.Source.CLOUD_SCHEDULER, taskContext.getType().toString(),
