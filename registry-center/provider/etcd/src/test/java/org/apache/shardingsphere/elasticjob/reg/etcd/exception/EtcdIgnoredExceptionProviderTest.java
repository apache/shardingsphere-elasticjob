...
class EtcdIgnoredExceptionProviderTest {
    ...
    private final EtcdIgnoredExceptionProvider provider = new EtcdIgnoredExceptionProvider();
    
    @Test
    void assertGetIgnoredExceptions() {
        Collection<Class<? extends Throwable>> ignoredExceptions = provider.getIgnoredExceptions();
