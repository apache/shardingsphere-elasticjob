...
/**
 * Nacos ignored exception provider.
 */
public final class NacosIgnoredExceptionProvider implements IgnoredExceptionProvider {
    
    @Override
    public Collection<Class<? extends Throwable>> getIgnoredExceptions() {
        return Collections.singletonList(NacosException.class);
    }
}
