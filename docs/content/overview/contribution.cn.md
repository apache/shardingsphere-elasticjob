...
### 报告一个新bug之前
 ...
 - 请确定这不是一个重复的bug。
   查看[Issue Page](https://github.com/apache/shardingsphere-elasticjob-lite/issues)列表，搜索您要提交的bug是否已经被报告过。

### 如何提交一个有质量的bug

请在[Issue Page](https://github.com/apache/shardingsphere-elasticjob-lite/issues)页面中提交bug。
...
### 提交一个功能增强建议之前
 ...
 - 请确定这不是一个重复的功能增强建议。
   查看[Issue Page](https://github.com/apache/shardingsphere-elasticjob-lite/issues)列表，搜索您要提交的功能增强建议是否已经被提交过。

### 如何提交一个好的功能增强建议

请在[Issue Page](https://github.com/apache/shardingsphere-elasticjob-lite/issues)页面中提交功能增强建议。
...
请按照规范贡献代码，示例和文档。
 ...
 - 所有的问题与新功能请使用[Issue Page](https://github.com/apache/shardingsphere-elasticjob-lite/issues)进行管理。
