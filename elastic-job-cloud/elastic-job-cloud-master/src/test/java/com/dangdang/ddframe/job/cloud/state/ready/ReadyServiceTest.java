...
public final class ReadyServiceTest {
    ...
    public void assertGetAllEligibleJobContextsWithRootNode() {
        ...
        assertThat(readyService.getAllEligibleJobContexts(Collections.singletonList(JobContext.from(CloudJobConfigurationBuilder.createCloudJobConfiguration("eligible_job")))).size(), is(1));
        verify(regCenter).isExisted("/state/ready");
