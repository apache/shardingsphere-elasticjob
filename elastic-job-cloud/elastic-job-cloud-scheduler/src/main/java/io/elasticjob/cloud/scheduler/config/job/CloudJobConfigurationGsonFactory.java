...
import io.elasticjob.util.json.AbstractJobConfigurationGsonTypeAdapter;
...
import static io.elasticjob.cloud.scheduler.config.constants.CloudConfigurationConstants.APPLICATION_CONTEXT;
import static io.elasticjob.cloud.scheduler.config.constants.CloudConfigurationConstants.APP_NAME;
import static io.elasticjob.cloud.scheduler.config.constants.CloudConfigurationConstants.BEAN_NAME;
import static io.elasticjob.cloud.scheduler.config.constants.CloudConfigurationConstants.CPU_COUNT;
import static io.elasticjob.cloud.scheduler.config.constants.CloudConfigurationConstants.JOB_EXECUTION_TYPE;
