            ...
            <form id="job-settings-form" class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <label for="jobName" class="col-sm-6 control-label"><i>*</i>作业名称</label>
                        <div class="col-sm-6">
                            <input type="text" placeholder="yourJob" id="jobName" name="jobName" class="form-control" data-toggle="tooltip" data-placement="bottom" title="作业名称" required/>
                        </div>
                    </div>
                    <div class="col-sm-4">
                ...
                <div class="form-group">
                    <label for="appURL" class="col-sm-2 control-label"><i>*</i>应用所在路径</label>
                        <div class="col-sm-9">
                            <input type="text" placeholder="http://file_host:8080/foo-job.tar.gz" id="appURL" name="appURL" class="form-control" data-toggle="tooltip" data-placement="bottom" title="  必须是可以通过网络访问到的路径。如：http://file_host:8080/your-job.tar.gz" required />
                        </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text"  disabled = "disabled" id="scriptCommandLine" name="scriptCommandLine" class="form-control" data-toggle="tooltip" data-placement="bottom" title="SCRIPT类型作业命令行执行脚本" />
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group" style="text-align: center;" >
                   <button type="submit" class="btn btn-primary" id = "save_form">保存</button>
