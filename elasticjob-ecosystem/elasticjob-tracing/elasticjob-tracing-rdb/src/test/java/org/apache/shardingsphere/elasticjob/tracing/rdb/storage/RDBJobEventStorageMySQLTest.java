...
public final class RDBJobEventStorageMySQLTest {
    ...
    public void setup() throws SQLException {
        ...
        dataSource.setUrl(dbConfiguration.getURL("test"));
    ...
    public void assertAddJobExecutionEvent() {
        assertTrue(storage.addJobExecutionEvent(new JobExecutionEvent("localhost", "127.0.0.1", "fake_task_id",
                "test_job", JobExecutionEvent.ExecutionSource.NORMAL_TRIGGER, 0)));
    }

    @Test
    public void assertAddJobStatusTraceEvent() {
        assertTrue(storage.addJobStatusTraceEvent(
                new JobStatusTraceEvent("test_job", "fake_task_id", "fake_slave_id", Source.LITE_EXECUTOR, "READY",
    ...
    public void assertAddJobStatusTraceEventWhenFailoverWithTaskStagingState() {
        JobStatusTraceEvent jobStatusTraceEvent = new JobStatusTraceEvent(
                "test_job", "fake_failover_task_id", "fake_slave_id", Source.LITE_EXECUTOR, "FAILOVER", "0",
    ...
    public void assertAddJobStatusTraceEventWhenFailoverWithTaskFailedState() {
        JobStatusTraceEvent stagingJobStatusTraceEvent = new JobStatusTraceEvent(
                "test_job", "fake_failed_failover_task_id", "fake_slave_id", Source.LITE_EXECUTOR, "FAILOVER", "0",
                State.TASK_STAGING, "message is empty.");
        ...
        List<JobStatusTraceEvent> jobStatusTraceEvents = storage.getJobStatusTraceEvents(
    ...
    public void assertUpdateJobExecutionEventWhenSuccess() {
        JobExecutionEvent startEvent = new JobExecutionEvent("localhost", "127.0.0.1", "fake_task_id", "test_job",
    ...
    public void assertUpdateJobExecutionEventWhenFailureAndMessageExceed() {
        ...
        JobExecutionEvent failEvent =
                startEvent.executionFailure("java.lang.RuntimeException: failure" + failureMsg.toString());
    ...
    public void assertFindJobExecutionEvent() {
        storage.addJobExecutionEvent(new JobExecutionEvent("localhost", "127.0.0.1", "fake_task_id", "test_job",
                JobExecutionEvent.ExecutionSource.NORMAL_TRIGGER, 0));
    }
